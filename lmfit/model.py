...
class ModelResult(Minimizer):
    ...
    def summary(self):
        """Represent many statistics and attributes of a ModelResult as a dict
        ...
        model, method, ndata, nvarys, nfree, chisqr, redchi, aic, bic,
        rsquared, nfev, max_nfev, aborted, errorbars, success, message,
        lmdif_message, ier, nan_policy, scale_covar, calc_covar, ci_out,
        col_deriv, flatchain, call_kws, var_names, user_options, kws,
        init_values, best_values, params

        with the 'params' being a list of parameter 'states', tuples with
        entries of (name, value, vary, expr, min, max, brute_step, stderr,
        correl, init_value, user_data)
